...
#Need parcel coordinates (x, y)
#Data only goes to 10-2018. DCL started in Dec. 2017
...
parcel = df
parcel['date'] = pd.to_datetime(df["updatedAt_dt"])
parcel = parcel.set_index('date')
parcel.to_csv("parcel_data.csv")

# parcel = parcel[['price']]
# parcel = parcel.tail(5)
...
# write_api.write(bucket=bucket, org=org, record=parcel,
#                 data_frame_measurement_name='price_sold',
#                 data_frame_tag_columns=['Parcels'])
